...
// Model is taken from env (ANTHROPIC_MODEL) and defaults to the value the
// product spec named: claude-sonnet-4-6. If that exact slug is rejected by the
// API the operator can override via env without code changes.
